...
namespace MailSender.lib.Service
{
    public class TaskMailSchedulerService : IMailSchedulerService
    {
        ...
        private readonly CancellationTokenSource _TaskCancelation = new CancellationTokenSource();
        ...
        public void Stop() => _TaskCancelation.Cancel();

        private async void SchedulerTaskMethodAsync()
        {
            var cancel = _TaskCancelation.Token;
            while (true)
            {
